...
public class pres3 {
    public static void main(String[] args) throws FileNotFoundException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException  {
        ...
        Scanner scanner =new Scanner(System.in); // lire d'après la saisie du clavier
        System.out.println("Saisir le nom de la classe de la couche dao : ");
        ...
        System.out.println("Saisir le nom de la classe de la couche Metier  : ");
